...
(let (
  ...
  (custom-theme-set-faces
   ...
   `(highlight ((t (:background ,d-aquamarine-4 :foreground ,d-white-1 :bold t))))
   ...
   `(company-preview ((t (:foreground ,d-aquamarine-4 :inherit hl-line :bold t))))
   `(company-preview-common ((t (:foreground ,d-aquamarine-4 :inherit hl-line :bold t))))
   ...
   `(company-tooltip-common ((t (:foreground ,d-aquamarine-4 :weight bold))))
   ...
   `(ivy-posframe-border ((t (:background ,d-aquamarine-3))))
